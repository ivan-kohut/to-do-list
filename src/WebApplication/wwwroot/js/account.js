(function (app) {
  ...
  app.initTwoFactorAuthenticationLogic = function () {
    ...
    callAPI(`${usersURL}/two-factor-authentication/is-enabled`, "GET", null, function (isTwoFactorAuthenticationEnabled) {
  ...
  app.enableTwoFactorAuthentication = function () {
    ...
    callAPI(`${usersURL}/two-factor-authentication/enable`, "PUT", data, function () {
  ...
  app.disableTwoFactorAuthentication = function () {
    callAPI(`${usersURL}/two-factor-authentication/disable`, "PUT", null, function () {
      window.location.href = "/";
    });
  };
  ...
  app.changePassword = function () {
    ...
    callAPI(`${usersURL}/password`, "PUT", data, function () {
